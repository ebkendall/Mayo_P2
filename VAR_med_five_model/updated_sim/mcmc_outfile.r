...
labels = c("slope S2 (hemo)", "slope S3 (hemo)", "slope S4 (hemo)", "slope S5 (hemo)",
           ...
           "intercept: S1 --> S2", "intercept: S1 --> S4", "intercept: S2 --> S3", 
           "intercept: S2 --> S4", "intercept: S3 --> S1", "intercept: S3 --> S2", 
