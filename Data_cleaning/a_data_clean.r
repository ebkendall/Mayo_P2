...
print('loading data')
jw1 = read.csv("raw_data/jw1b.csv")
jw2 = read.csv("raw_data/jw2b.csv")
jw3 = read.csv("raw_data/jw3b.csv")
jw4 = read.csv("raw_data/jw4b.csv")
jw5 = read.csv("raw_data/jw5b.csv")
jw6 = read.csv("raw_data/jw6b.csv")
jw7 = read.csv("raw_data/jw7b.csv")
jw8 = read.csv("raw_data/jw8b.csv")
jw9 = read.csv("raw_data/jw9b.csv")
jw10 = read.csv("raw_data/jw10b.csv")
jw11 = read.csv("raw_data/jw11b.csv")
jw12 = read.csv("raw_data/jw12b.csv")
jw13 = read.csv("raw_data/jw13b.csv")
jw14 = read.csv("raw_data/jw14b.csv")
jw_t = read.csv("raw_data/jw_transfusions.csv")
